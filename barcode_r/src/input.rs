...
#[doc = " struct input_absinfo - used by EVIOCGABS/EVIOCSABS ioctls"]
#[doc = " @value: latest reported value for the axis."]
#[doc = " @minimum: specifies minimum value for the axis."]
#[doc = " @maximum: specifies maximum value for the axis."]
#[doc = " @fuzz: specifies fuzz value that is used to filter noise from"]
#[doc = "\tthe event stream."]
#[doc = " @flat: values that are within this value will be discarded by"]
#[doc = "\tjoydev interface and reported as 0 instead."]
#[doc = " @resolution: specifies resolution for the values reported for"]
#[doc = "\tthe axis."]
#[doc = ""]
#[doc = " Note that input core does not clamp reported values to the"]
#[doc = " [minimum, maximum] limits, such task is left to userspace."]
#[doc = ""]
#[doc = " The default resolution for main axes (ABS_X, ABS_Y, ABS_Z)"]
#[doc = " is reported in units per millimeter (units/mm), resolution"]
#[doc = " for rotational axes (ABS_RX, ABS_RY, ABS_RZ) is reported"]
#[doc = " in units per radian."]
#[doc = " When INPUT_PROP_ACCELEROMETER is set the resolution changes."]
#[doc = " The main axes (ABS_X, ABS_Y, ABS_Z) are then reported in"]
#[doc = " in units per g (units/g) and in units per degree per second"]
#[doc = " (units/deg/s) for rotational axes (ABS_RX, ABS_RY, ABS_RZ)."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " struct input_keymap_entry - used by EVIOCGKEYCODE/EVIOCSKEYCODE ioctls"]
#[doc = " @scancode: scancode represented in machine-endian form."]
#[doc = " @len: length of the scancode that resides in @scancode buffer."]
#[doc = " @index: index in the keymap, may be used instead of scancode"]
#[doc = " @flags: allows to specify how kernel should handle the request. For"]
#[doc = "\texample, setting INPUT_KEYMAP_BY_INDEX flag indicates that kernel"]
#[doc = "\tshould perform lookup in keymap by @index instead of @scancode"]
#[doc = " @keycode: key code assigned to this scancode"]
#[doc = ""]
#[doc = " The structure is used to retrieve and modify keymap data. Users have"]
#[doc = " option of performing lookup either by @scancode itself or by @index"]
#[doc = " in keymap entry. EVIOCGKEYCODE will also return scancode or index"]
#[doc = " (depending on which element was used to perform lookup)."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " struct ff_replay - defines scheduling of the force-feedback effect"]
#[doc = " @length: duration of the effect"]
#[doc = " @delay: delay before effect should start playing"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " struct ff_trigger - defines what triggers the force-feedback effect"]
#[doc = " @button: number of the button triggering the effect"]
#[doc = " @interval: controls how soon the effect can be re-triggered"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " struct ff_envelope - generic force-feedback effect envelope"]
#[doc = " @attack_length: duration of the attack (ms)"]
#[doc = " @attack_level: level at the beginning of the attack"]
#[doc = " @fade_length: duration of fade (ms)"]
#[doc = " @fade_level: level at the end of fade"]
#[doc = ""]
#[doc = " The @attack_level and @fade_level are absolute values; when applying"]
#[doc = " envelope force-feedback core will convert to positive/negative"]
#[doc = " value based on polarity of the default level of the effect."]
#[doc = " Valid range for the attack and fade levels is 0x0000 - 0x7fff"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " struct ff_constant_effect - defines parameters of a constant force-feedback effect"]
#[doc = " @level: strength of the effect; may be negative"]
#[doc = " @envelope: envelope data"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " struct ff_ramp_effect - defines parameters of a ramp force-feedback effect"]
#[doc = " @start_level: beginning strength of the effect; may be negative"]
#[doc = " @end_level: final strength of the effect; may be negative"]
#[doc = " @envelope: envelope data"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " struct ff_condition_effect - defines a spring or friction force-feedback effect"]
#[doc = " @right_saturation: maximum level when joystick moved all way to the right"]
#[doc = " @left_saturation: same for the left side"]
#[doc = " @right_coeff: controls how fast the force grows when the joystick moves"]
#[doc = "\tto the right"]
#[doc = " @left_coeff: same for the left side"]
#[doc = " @deadband: size of the dead zone, where no force is produced"]
#[doc = " @center: position of the dead zone"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " struct ff_periodic_effect - defines parameters of a periodic force-feedback effect"]
#[doc = " @waveform: kind of the effect (wave)"]
#[doc = " @period: period of the wave (ms)"]
#[doc = " @magnitude: peak value"]
#[doc = " @offset: mean value of the wave (roughly)"]
#[doc = " @phase: 'horizontal' shift"]
#[doc = " @envelope: envelope data"]
#[doc = " @custom_len: number of samples (FF_CUSTOM only)"]
#[doc = " @custom_data: buffer of samples (FF_CUSTOM only)"]
#[doc = ""]
#[doc = " Known waveforms - FF_SQUARE, FF_TRIANGLE, FF_SINE, FF_SAW_UP,"]
#[doc = " FF_SAW_DOWN, FF_CUSTOM. The exact syntax FF_CUSTOM is undefined"]
#[doc = " for the time being as no driver supports it yet."]
#[doc = ""]
#[doc = " Note: the data pointed by custom_data is copied by the driver."]
#[doc = " You can therefore dispose of the memory after the upload/update."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " struct ff_rumble_effect - defines parameters of a periodic force-feedback effect"]
#[doc = " @strong_magnitude: magnitude of the heavy motor"]
#[doc = " @weak_magnitude: magnitude of the light one"]
#[doc = ""]
#[doc = " Some rumble pads have two motors of different weight. Strong_magnitude"]
#[doc = " represents the magnitude of the vibration generated by the heavy one."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " struct ff_effect - defines force feedback effect"]
#[doc = " @type: type of the effect (FF_CONSTANT, FF_PERIODIC, FF_RAMP, FF_SPRING,"]
#[doc = "\tFF_FRICTION, FF_DAMPER, FF_RUMBLE, FF_INERTIA, or FF_CUSTOM)"]
#[doc = " @id: an unique id assigned to an effect"]
#[doc = " @direction: direction of the effect"]
#[doc = " @trigger: trigger conditions (struct ff_trigger)"]
#[doc = " @replay: scheduling of the effect (struct ff_replay)"]
#[doc = " @u: effect-specific structure (one of ff_constant_effect, ff_ramp_effect,"]
#[doc = "\tff_periodic_effect, ff_condition_effect, ff_rumble_effect) further"]
#[doc = "\tdefining effect parameters"]
#[doc = ""]
#[doc = " This structure is sent through ioctl from the application to the driver."]
#[doc = " To create a new effect application should set its @id to -1; the kernel"]
#[doc = " will return assigned @id which can later be used to update or delete"]
#[doc = " this effect."]
#[doc = ""]
#[doc = " Direction of the effect is encoded as follows:"]
#[doc = "\t0 deg -> 0x0000 (down)"]
#[doc = "\t90 deg -> 0x4000 (left)"]
#[doc = "\t180 deg -> 0x8000 (up)"]
#[doc = "\t270 deg -> 0xC000 (right)"]
#[repr(C)]
#[derive(Copy, Clone)]
